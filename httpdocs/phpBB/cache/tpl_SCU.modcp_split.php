...
// eXtreme Styles mod cache. Generated on Mon, 24 Oct 2005 22:56:42 -0700 (time=1130219802)
...
<form method="post" action="<?php echo isset($this->vars['S_SPLIT_ACTION']) ? $this->vars['S_SPLIT_ACTION'] : $this->lang('S_SPLIT_ACTION'); ?>">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  <td align="left" class="nav"><a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="nav"><?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?></a><span class="nav"> 
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <th height="25" class="thHead" colspan="3" nowrap="nowrap"><?php echo isset($this->vars['L_SPLIT_TOPIC']) ? $this->vars['L_SPLIT_TOPIC'] : $this->lang('L_SPLIT_TOPIC'); ?></th>
	</tr>
	<tr> 
	  <td class="row2" colspan="3" align="center"><span class="gensmall"><?php echo isset($this->vars['L_SPLIT_TOPIC_EXPLAIN']) ? $this->vars['L_SPLIT_TOPIC_EXPLAIN'] : $this->lang('L_SPLIT_TOPIC_EXPLAIN'); ?></span></td>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="thLeft" nowrap="nowrap"><?php echo isset($this->vars['L_AUTHOR']) ? $this->vars['L_AUTHOR'] : $this->lang('L_AUTHOR'); ?></th>
	  <th nowrap="nowrap"><?php echo isset($this->vars['L_MESSAGE']) ? $this->vars['L_MESSAGE'] : $this->lang('L_MESSAGE'); ?></th>
	  <th class="thRight" nowrap="nowrap"><?php echo isset($this->vars['L_SELECT']) ? $this->vars['L_SELECT'] : $this->lang('L_SELECT'); ?></th>
	</tr>
	<?php
...
?>
	<tr> 
	  ...
	  <td width="100%" valign="top" class="<?php echo isset($postrow_item['ROW_CLASS']) ? $postrow_item['ROW_CLASS'] : ''; ?>"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="templates/BMan1Blue/images/icon_minipost.gif" alt="<?php echo isset($this->vars['L_POST']) ? $this->vars['L_POST'] : $this->lang('L_POST'); ?>"><span class="postdetails"><?php echo isset($this->vars['L_POSTED']) ? $this->vars['L_POSTED'] : $this->lang('L_POSTED'); ?>: 
		  ...
		  <tr> 
			<td valign="top"> 
			  <hr size="1" />
			  <span class="postbody"><?php echo isset($postrow_item['MESSAGE']) ? $postrow_item['MESSAGE'] : ''; ?></span></td> 
		  </tr>
		</table>
	  </td>
	...
	<tr> 
	  <td colspan="3" height="1" class="row3"><img src="templates/BMan1Blue/images/spacer.gif" width="1" height="1" alt="."></td>
	</tr>
	<?php
