...
// eXtreme Styles mod cache. Generated on Mon, 26 Sep 2005 21:35:00 -0700 (time=1127795700)
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- JSL second email field mod -->
	<tr> 
		<td class="row1"><span class="gen"><?php echo isset($this->vars['L_EMAIL_ADDRESS']) ? $this->vars['L_EMAIL_ADDRESS'] : $this->lang('L_EMAIL_ADDRESS'); ?>: *</span><br />
		<span class="gensmall">Forum E-mail notifications will be sent to this E-mail address.</span></td>
	...
	<tr> 
		<td class="row1"><span class="gen"><?php echo isset($this->vars['L_EMAIL_ADDRESS_2']) ? $this->vars['L_EMAIL_ADDRESS_2'] : $this->lang('L_EMAIL_ADDRESS_2'); ?>: </span><br />
		<span class="gensmall">In addition, forum E-mail notifications will be sent to this other E-mail address.</span></td>
		<td class="row2"><input type="text" class="post" style="width:200px" name="email_2" size="25" maxlength="255" value="<?php echo isset($this->vars['EMAIL_2']) ? $this->vars['EMAIL_2'] : $this->lang('EMAIL_2'); ?>" /></td>
	</tr>
...
?>
	<tr> 
	  ...
	  <td class="row2"> 
		<input type="password" class="post" style="width: 200px" name="new_password" size="25" maxlength="100" value="<?php echo isset($this->vars['NEW_PASSWORD']) ? $this->vars['NEW_PASSWORD'] : $this->lang('NEW_PASSWORD'); ?>" />
	  </td>
	</tr>
	<tr> 
...
?> 
	...
	<tr> 
		<td class="row1"><span class="gen"><?php echo isset($this->vars['L_CONFIRM_CODE']) ? $this->vars['L_CONFIRM_CODE'] : $this->lang('L_CONFIRM_CODE'); ?>: * </span><br /><span class="gensmall"><?php echo isset($this->vars['L_CONFIRM_CODE_EXPLAIN']) ? $this->vars['L_CONFIRM_CODE_EXPLAIN'] : $this->lang('L_CONFIRM_CODE_EXPLAIN'); ?></span></td> <td class="row2"><input type="text" class="post" style="width: 200px" name="confirm_code" size="6" maxlength="6" value="" /></td> 
	</tr> 
	<?php
...
?> 
	...
	<tr> 
	  <td class="row1"><span class="gen"><?php echo isset($this->vars['L_PUBLIC_VIEW_EMAIL']) ? $this->vars['L_PUBLIC_VIEW_EMAIL'] : $this->lang('L_PUBLIC_VIEW_EMAIL'); ?>:</span><br />
		<span class="gensmall">This puts a convenient email button under each message you post so that the reader can click it to send you a traditional email. 
		This also allows the reader to see your email address.</span></td>
