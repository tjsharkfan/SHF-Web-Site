...
// eXtreme Styles mod cache. Generated on Fri, 12 Aug 2005 23:05:37 -0700 (time=1123913137)
...
<head>
  ...
  <link rel="stylesheet" href="templates/SCU/<?php echo isset($this->vars['T_HEAD_STYLESHEET']) ? $this->vars['T_HEAD_STYLESHEET'] : $this->lang('T_HEAD_STYLESHEET'); ?>" type="text/css" />

  <style type="text/css"><!--
    body { background-image: url(templates/SCU/images/body_bg.gif); }
    td.banner { background-image: url(templates/SCU/images/SCU_logo_bg.gif); background-color: #C0C0C0; }
    td.rowpic { background-image: url(templates/SCU/images/<?php echo isset($this->vars['T_TH_CLASS3']) ? $this->vars['T_TH_CLASS3'] : $this->lang('T_TH_CLASS3'); ?>); }
    th { background-image: url(templates/SCU/images/<?php echo isset($this->vars['T_TH_CLASS2']) ? $this->vars['T_TH_CLASS2'] : $this->lang('T_TH_CLASS2'); ?>); }
    td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom { background-image: url(templates/SCU/images/<?php echo isset($this->vars['T_TH_CLASS1']) ? $this->vars['T_TH_CLASS1'] : $this->lang('T_TH_CLASS1'); ?>); }
    ...
    @import url("templates/SCU/formIE.css");
  --></style>
...
<table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
  <tr>
    <td class="banner" align="absbottom" align="left"><img src="templates/SCU/images/SCU_logo.jpg" alt="" border="0" />
    <td class="banner" align="absbottom" align="right"><img src="templates/SCU/images/SCU_EMBA_title.jpg" alt="" border="0" /></td>
  </tr>
    ...
    <td align="center"><table cellspacing="0" cellpadding="2" border="0">
      <tr>
	   <td class="mainmenubody">
					<span class="mainmenu">
					<a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="mainmenu">Home</a> <b>&middot;</b> 
					<a href="<?php echo isset($this->vars['U_CALENDAR']) ? $this->vars['U_CALENDAR'] : $this->lang('U_CALENDAR'); ?>" class="mainmenu"><?php echo isset($this->vars['L_CALENDAR']) ? $this->vars['L_CALENDAR'] : $this->lang('L_CALENDAR'); ?></a> <b>&middot;</b>
					<a href="<?php echo isset($this->vars['U_SEARCH']) ? $this->vars['U_SEARCH'] : $this->lang('U_SEARCH'); ?>" class="mainmenu"><?php echo isset($this->vars['L_SEARCH']) ? $this->vars['L_SEARCH'] : $this->lang('L_SEARCH'); ?></a> <b>&middot;</b>
					<a href="<?php echo isset($this->vars['U_PROFILE']) ? $this->vars['U_PROFILE'] : $this->lang('U_PROFILE'); ?>" class="mainmenu">My Profile</a> <b>&middot;</b> 
					<a href="<?php echo isset($this->vars['U_PRIVATEMSGS']) ? $this->vars['U_PRIVATEMSGS'] : $this->lang('U_PRIVATEMSGS'); ?>" class="mainmenu">My Private Messages</a> <b>&middot;</b> 
					<a href="<?php echo isset($this->vars['U_FAQ']) ? $this->vars['U_FAQ'] : $this->lang('U_FAQ'); ?>" class="mainmenu"><?php echo isset($this->vars['L_FAQ']) ? $this->vars['L_FAQ'] : $this->lang('L_FAQ'); ?></a> <b>&middot;</b> 
				 <!-- <a href="<?php echo isset($this->vars['U_MEMBERLIST']) ? $this->vars['U_MEMBERLIST'] : $this->lang('U_MEMBERLIST'); ?>" class="mainmenu"><?php echo isset($this->vars['L_MEMBERLIST']) ? $this->vars['L_MEMBERLIST'] : $this->lang('L_MEMBERLIST'); ?></a> <b>&middot;</b> -->
					<a href="<?php echo isset($this->vars['U_MEMBERLIST']) ? $this->vars['U_MEMBERLIST'] : $this->lang('U_MEMBERLIST'); ?>" class="mainmenu">Registered Users</a> <b>&middot;</b> 
				 <!-- <a href="<?php echo isset($this->vars['U_GROUP_CP']) ? $this->vars['U_GROUP_CP'] : $this->lang('U_GROUP_CP'); ?>" class="mainmenu"><?php echo isset($this->vars['L_USERGROUPS']) ? $this->vars['L_USERGROUPS'] : $this->lang('L_USERGROUPS'); ?></a> -->
					<a href="<?php echo isset($this->vars['U_GROUP_CP']) ? $this->vars['U_GROUP_CP'] : $this->lang('U_GROUP_CP'); ?>" class="mainmenu">EMBA Groups</a> <b>&middot;</b> 
				 	<a href="<?php echo isset($this->vars['U_GALLERY']) ? $this->vars['U_GALLERY'] : $this->lang('U_GALLERY'); ?>" class="mainmenu">Photo Gallery</a>
				 <!-- <a href="<?php echo isset($this->vars['U_PAYMENTS']) ? $this->vars['U_PAYMENTS'] : $this->lang('U_PAYMENTS'); ?>" class="mainmenu"><?php echo isset($this->vars['L_PAYMENTS']) ? $this->vars['L_PAYMENTS'] : $this->lang('L_PAYMENTS'); ?></a> <b>&middot;</b> -->
