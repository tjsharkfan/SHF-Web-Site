...
// eXtreme Styles mod cache. Generated on Sun,  4 Sep 2005 20:17:17 -0700 (time=1125890237)
...
?>
    <span class="gen"><b><?php echo isset($faq_block_link_item['BLOCK_TITLE']) ? $faq_block_link_item['BLOCK_TITLE'] : ''; ?></b></span><br />
    <?php
...
?>  
  <tr> 
    <td class="<?php echo isset($faq_row_item['ROW_CLASS']) ? $faq_row_item['ROW_CLASS'] : ''; ?>" align="left" valign="top"><span class="postbody"><a name="<?php echo isset($faq_row_item['U_FAQ_ID']) ? $faq_row_item['U_FAQ_ID'] : ''; ?>"></a><b><?php echo isset($faq_row_item['FAQ_QUESTION']) ? $faq_row_item['FAQ_QUESTION'] : ''; ?></b></span><br /><span class="postbody"><?php echo isset($faq_row_item['FAQ_ANSWER']) ? $faq_row_item['FAQ_ANSWER'] : ''; ?><br /><a class="postlink" href="#top"><?php echo isset($this->vars['L_BACK_TO_TOP']) ? $this->vars['L_BACK_TO_TOP'] : $this->lang('L_BACK_TO_TOP'); ?></a></span></td>
  </tr>
  <tr>
    <td class="spaceRow" height="1"><img src="templates/BMan1Blue/images/spacer.gif" alt="" width="1" height="1" /></td>
  </tr>
  <?php
...
<table width="100%" cellspacing="2" cellspacing="2" border="0">
  <tr>
    <td align="right" valign="middle" nowrap="nowrap"><span class="gensmall"><?php echo isset($this->vars['S_TIMEZONE']) ? $this->vars['S_TIMEZONE'] : $this->lang('S_TIMEZONE'); ?></span></td>
  </tr>
  <tr>
