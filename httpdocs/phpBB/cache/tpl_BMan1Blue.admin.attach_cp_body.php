...
// eXtreme Styles mod cache. Generated on Tue,  9 Aug 2005 20:56:54 -0700 (time=1123646214)
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	...
	<td class="row2"><b><?php echo isset($this->vars['NUMBER_OF_ATTACHMENTS']) ? $this->vars['NUMBER_OF_ATTACHMENTS'] : $this->lang('NUMBER_OF_ATTACHMENTS'); ?></b></td>
  </tr>
  <tr> 
	...
	<td class="row2"><b><?php echo isset($this->vars['TOTAL_FILESIZE']) ? $this->vars['TOTAL_FILESIZE'] : $this->lang('TOTAL_FILESIZE'); ?></b></td>
  </tr>
  <tr> 
	<td class="row1" nowrap="nowrap"><?php echo isset($this->vars['L_ATTACH_QUOTA']) ? $this->vars['L_ATTACH_QUOTA'] : $this->lang('L_ATTACH_QUOTA'); ?>:</td>
	<td class="row2"><b><?php echo isset($this->vars['ATTACH_QUOTA']) ? $this->vars['ATTACH_QUOTA'] : $this->lang('ATTACH_QUOTA'); ?></b></td>
  </tr>
  <tr> 
  ...
  <tr> 
	...
	<td class="row2"><b><?php echo isset($this->vars['NUMBER_OF_PMS']) ? $this->vars['NUMBER_OF_PMS'] : $this->lang('NUMBER_OF_PMS'); ?></b></td>
  </tr>
  <tr> 
