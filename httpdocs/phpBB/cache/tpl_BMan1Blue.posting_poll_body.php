...
?>
			<tr>
				<th class="thHead" colspan="2"><?php echo isset($this->vars['L_ADD_A_POLL']) ? $this->vars['L_ADD_A_POLL'] : $this->lang('L_ADD_A_POLL'); ?></th>
	        </tr>
			<tr>
				<td class="row1" colspan="2"><span class="gensmall"><?php echo isset($this->vars['L_ADD_POLL_EXPLAIN']) ? $this->vars['L_ADD_POLL_EXPLAIN'] : $this->lang('L_ADD_POLL_EXPLAIN'); ?></span></td>
	        </tr>
            <tr>
				<td class="row1"><span class="gen"><b><?php echo isset($this->vars['L_POLL_QUESTION']) ? $this->vars['L_POLL_QUESTION'] : $this->lang('L_POLL_QUESTION'); ?></b></span></td>
				<td class="row2"><span class="genmed"><input type="text" name="poll_title" size="50" maxlength="255" class="post" value="<?php echo isset($this->vars['POLL_TITLE']) ? $this->vars['POLL_TITLE'] : $this->lang('POLL_TITLE'); ?>" /></span></td>
			</tr>
			<?php
...
?>
            <tr>
				<td class="row1"><span class="gen"><b><?php echo isset($this->vars['L_POLL_OPTION']) ? $this->vars['L_POLL_OPTION'] : $this->lang('L_POLL_OPTION'); ?></b></span></td>
				<td class="row2"><span class="genmed"><input type="text" name="add_poll_option_text" size="50" maxlength="255" class="post" value="<?php echo isset($this->vars['ADD_POLL_OPTION']) ? $this->vars['ADD_POLL_OPTION'] : $this->lang('ADD_POLL_OPTION'); ?>" /></span> &nbsp;<input type="submit" name="add_poll_option" value="<?php echo isset($this->vars['L_ADD_OPTION']) ? $this->vars['L_ADD_OPTION'] : $this->lang('L_ADD_OPTION'); ?>" class="liteoption" /></td>
			</tr>
            <tr>
				<td class="row1"><span class="gen"><b><?php echo isset($this->vars['L_POLL_LENGTH']) ? $this->vars['L_POLL_LENGTH'] : $this->lang('L_POLL_LENGTH'); ?></b></span></td>
				<td class="row2"><span class="genmed"><input type="text" name="poll_length" size="3" maxlength="3" class="post" value="<?php echo isset($this->vars['POLL_LENGTH']) ? $this->vars['POLL_LENGTH'] : $this->lang('POLL_LENGTH'); ?>" /></span>&nbsp;<span class="gen"><b><?php echo isset($this->vars['L_DAYS']) ? $this->vars['L_DAYS'] : $this->lang('L_DAYS'); ?></b></span> &nbsp; <span class="gensmall"><?php echo isset($this->vars['L_POLL_LENGTH_EXPLAIN']) ? $this->vars['L_POLL_LENGTH_EXPLAIN'] : $this->lang('L_POLL_LENGTH_EXPLAIN'); ?></span></td>
			</tr>
			<?php
...
?>
            <tr>
				<td class="row1"><span class="gen"><b><?php echo isset($this->vars['L_POLL_DELETE']) ? $this->vars['L_POLL_DELETE'] : $this->lang('L_POLL_DELETE'); ?></b></span></td>
