...
// eXtreme Styles mod cache. Generated on Mon, 24 Oct 2005 22:55:43 -0700 (time=1130219743)
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr> 
	<td align="left"><span class="nav"><a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="nav"><?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?></a> -> <a href="<?php echo isset($this->vars['U_VIEW_FORUM']) ? $this->vars['U_VIEW_FORUM'] : $this->lang('U_VIEW_FORUM'); ?>" class="nav"><?php echo isset($this->vars['FORUM_NAME']) ? $this->vars['FORUM_NAME'] : $this->lang('FORUM_NAME'); ?></a></span></td>
  </tr>
</table>
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="spaceRow" colspan="6" align="center"><span class="gensmall"><?php echo isset($this->vars['L_MOD_CP_EXPLAIN']) ? $this->vars['L_MOD_CP_EXPLAIN'] : $this->lang('L_MOD_CP_EXPLAIN'); ?></span></td>
	</tr>
	<tr> 
	  ...
	  <th width="5%" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_SELECT']) ? $this->vars['L_SELECT'] : $this->lang('L_SELECT'); ?>&nbsp;</th>
	  <th width="10%" class="thRight" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_PRIORITY']) ? $this->vars['L_PRIORITY'] : $this->lang('L_PRIORITY'); ?>&nbsp;</th>
	</tr>
	<?php
...
?>
	<tr align="right"> 
	  <td class="catBottom" colspan="6" height="29"> <?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?> 
		...
		&nbsp; 
		<input type="submit" name="merge" class="liteoption" value="<?php echo isset($this->vars['L_MERGE']) ? $this->vars['L_MERGE'] : $this->lang('L_MERGE'); ?>" />		
	  </td>
	</tr>
  </table>
