...
// eXtreme Styles mod cache. Generated on Wed, 10 Aug 2005 23:30:55 -0700 (time=1123741855)
...
?>
  <tr> 
    ...
    <td class="row2" align="right"><table width="90%" cellspacing="0" cellpadding="0" border="0">
      <tr><form method="get" action="<?php echo isset($this->vars['S_USERGROUP_ACTION']) ? $this->vars['S_USERGROUP_ACTION'] : $this->lang('S_USERGROUP_ACTION'); ?>">
        ...
        <td align="center" width="30%"><input type="submit" value="<?php echo isset($this->vars['L_VIEW_INFORMATION']) ? $this->vars['L_VIEW_INFORMATION'] : $this->lang('L_VIEW_INFORMATION'); ?>" class="liteoption" /><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?></td>
      </form></tr>
    </table></td>
  </tr>
  <?php
