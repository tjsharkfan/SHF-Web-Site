...
// eXtreme Styles mod cache. Generated on Wed, 10 Aug 2005 22:34:23 -0700 (time=1123738463)
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
  ...
  <tr> 
    ...
    <td class="row2"><span class="genmed"><select class="post" name="search_cat"><?php echo isset($this->vars['S_CATEGORY_OPTIONS']) ? $this->vars['S_CATEGORY_OPTIONS'] : $this->lang('S_CATEGORY_OPTIONS'); ?></select></span></td>
  ...
  <tr> 
    ...
    <td class="row2" nowrap="nowrap"><input type="radio" name="show_results" value="posts" checked="checked" /><span class="genmed"><?php echo isset($this->vars['L_POSTS']) ? $this->vars['L_POSTS'] : $this->lang('L_POSTS'); ?><input type="radio" name="show_results" value="topics" /><?php echo isset($this->vars['L_TOPICS']) ? $this->vars['L_TOPICS'] : $this->lang('L_TOPICS'); ?></span></td>
