...
// eXtreme Styles mod cache. Generated on Wed, 10 Aug 2005 23:49:18 -0700 (time=1123742958)
...
<!-- Begin SpelChek? code snippet #1 -->
 <script>
 function sendtext() {
 var semi = new RegExp(";","g");
 document.send.checkme.value = (document.post.message.value.replace(semi,";"));
 document.send.form.value = "post";
 document.send.field.value = "message";
 document.send.box.value = "win";
 document.send.version.value = "1.3";
 window.open('http://spelchek.com/sc_data/loading.htm','SpelChek','width=700,height=370,top=150,left=150,scrollbars=1,titlebar=no,location=false');
 document.send.submit();
 }
 </script>
 <form name="send" id=send action="http://www.SpelChek.com/cgi-bin/spelchekplus.cgi" method="POST" target=SpelChek>
 <input type="hidden" id=checkme name="checkme">
 <input type="hidden" name="form">
 <input type="hidden" name="box">
 <input type="hidden" name="field">
 <input type="hidden" name="edittext">
 <input type="hidden" name="version">
 <input type="hidden" name="user" value="johnsonweb">
 <input type="hidden" name="spell" value="check">
 <script>
 document.write('<input type="hidden" name="mole" value="http://'+document.domain+'/phpBB/spelchek.html">')
 </script>
 </form>
 <!-- End SpelChek? code snippet #1 -->
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
		<td align="left"><span  class="nav"><a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>" class="nav"><?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?></a>
		<?php
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<th class="thHead" colspan="2" height="25"><b><?php echo isset($this->vars['L_POST_A']) ? $this->vars['L_POST_A'] : $this->lang('L_POST_A'); ?></b></th>
	</tr>
	<?php
...
?>
	<tr> 
		<td class="row1"><span class="gen"><b><?php echo isset($this->vars['L_USERNAME']) ? $this->vars['L_USERNAME'] : $this->lang('L_USERNAME'); ?></b></span></td>
		<td class="row2"><span class="genmed"><input type="text"  class="post" name="username" maxlength="25" size="25" tabindex="1" value="<?php echo isset($this->vars['USERNAME']) ? $this->vars['USERNAME'] : $this->lang('USERNAME'); ?>" />&nbsp;<input type="submit" name="usersubmit" value="<?php echo isset($this->vars['L_FIND_USERNAME']) ? $this->vars['L_FIND_USERNAME'] : $this->lang('L_FIND_USERNAME'); ?>" class="liteoption" onClick="window.open('<?php echo isset($this->vars['U_SEARCH_USER']) ? $this->vars['U_SEARCH_USER'] : $this->lang('U_SEARCH_USER'); ?>', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span></td>
	</tr>
	<?php
...
$switch_subject_count = ( isset($this->_tpldata['switch_subject.']) ) ?  sizeof($this->_tpldata['switch_subject.']) : 0;
for ($switch_subject_i = 0; $switch_subject_i < $switch_subject_count; $switch_subject_i++)
{
 $switch_subject_item = &$this->_tpldata['switch_subject.'][$switch_subject_i];
 $switch_subject_item['S_ROW_COUNT'] = $switch_subject_i;
 $switch_subject_item['S_NUM_ROWS'] = $switch_subject_count;

?>
	<tr>
	  <td class="row1" width="22%"><span class="gen"><b><?php echo isset($this->vars['L_SUBJECT']) ? $this->vars['L_SUBJECT'] : $this->lang('L_SUBJECT'); ?></b></span></td>
...
if(isset($switch_subject_item)) { unset($switch_subject_item); } 
				...
				<tr> 
				  <td><span class="genmed"> &nbsp;<?php echo isset($this->vars['L_FONT_COLOR']) ? $this->vars['L_FONT_COLOR'] : $this->lang('L_FONT_COLOR'); ?>: 
					<select name="addbbcode18" onChange="bbfontstyle('[color=' + this.form.addbbcode18.options[this.form.addbbcode18.selectedIndex].value + ']', '[/color]');this.selectedIndex=0;" onMouseOver="helpline('s')">
					  <option style="color:black; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="<?php echo isset($this->vars['T_FONTCOLOR1']) ? $this->vars['T_FONTCOLOR1'] : $this->lang('T_FONTCOLOR1'); ?>" class="genmed"><?php echo isset($this->vars['L_COLOR_DEFAULT']) ? $this->vars['L_COLOR_DEFAULT'] : $this->lang('L_COLOR_DEFAULT'); ?></option>
					  <option style="color:darkred; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="darkred" class="genmed"><?php echo isset($this->vars['L_COLOR_DARK_RED']) ? $this->vars['L_COLOR_DARK_RED'] : $this->lang('L_COLOR_DARK_RED'); ?></option>
					  <option style="color:red; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="red" class="genmed"><?php echo isset($this->vars['L_COLOR_RED']) ? $this->vars['L_COLOR_RED'] : $this->lang('L_COLOR_RED'); ?></option>
					  <option style="color:orange; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="orange" class="genmed"><?php echo isset($this->vars['L_COLOR_ORANGE']) ? $this->vars['L_COLOR_ORANGE'] : $this->lang('L_COLOR_ORANGE'); ?></option>
					  <option style="color:brown; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="brown" class="genmed"><?php echo isset($this->vars['L_COLOR_BROWN']) ? $this->vars['L_COLOR_BROWN'] : $this->lang('L_COLOR_BROWN'); ?></option>
					  <option style="color:yellow; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="yellow" class="genmed"><?php echo isset($this->vars['L_COLOR_YELLOW']) ? $this->vars['L_COLOR_YELLOW'] : $this->lang('L_COLOR_YELLOW'); ?></option>
					  <option style="color:green; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="green" class="genmed"><?php echo isset($this->vars['L_COLOR_GREEN']) ? $this->vars['L_COLOR_GREEN'] : $this->lang('L_COLOR_GREEN'); ?></option>
					  <option style="color:olive; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="olive" class="genmed"><?php echo isset($this->vars['L_COLOR_OLIVE']) ? $this->vars['L_COLOR_OLIVE'] : $this->lang('L_COLOR_OLIVE'); ?></option>
					  <option style="color:cyan; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="cyan" class="genmed"><?php echo isset($this->vars['L_COLOR_CYAN']) ? $this->vars['L_COLOR_CYAN'] : $this->lang('L_COLOR_CYAN'); ?></option>
					  <option style="color:blue; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="blue" class="genmed"><?php echo isset($this->vars['L_COLOR_BLUE']) ? $this->vars['L_COLOR_BLUE'] : $this->lang('L_COLOR_BLUE'); ?></option>
					  <option style="color:darkblue; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="darkblue" class="genmed"><?php echo isset($this->vars['L_COLOR_DARK_BLUE']) ? $this->vars['L_COLOR_DARK_BLUE'] : $this->lang('L_COLOR_DARK_BLUE'); ?></option>
					  <option style="color:indigo; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="indigo" class="genmed"><?php echo isset($this->vars['L_COLOR_INDIGO']) ? $this->vars['L_COLOR_INDIGO'] : $this->lang('L_COLOR_INDIGO'); ?></option>
					  <option style="color:violet; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="violet" class="genmed"><?php echo isset($this->vars['L_COLOR_VIOLET']) ? $this->vars['L_COLOR_VIOLET'] : $this->lang('L_COLOR_VIOLET'); ?></option>
					  <option style="color:white; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="white" class="genmed"><?php echo isset($this->vars['L_COLOR_WHITE']) ? $this->vars['L_COLOR_WHITE'] : $this->lang('L_COLOR_WHITE'); ?></option>
					  <option style="color:black; background-color: <?php echo isset($this->vars['T_TD_COLOR3']) ? $this->vars['T_TD_COLOR3'] : $this->lang('T_TD_COLOR3'); ?>" value="black" class="genmed"><?php echo isset($this->vars['L_COLOR_BLACK']) ? $this->vars['L_COLOR_BLACK'] : $this->lang('L_COLOR_BLACK'); ?></option>
...
?>
		  <tr> 
			...
			<td><span class="gen"><?php echo isset($this->vars['L_DELETE_POST']) ? $this->vars['L_DELETE_POST'] : $this->lang('L_DELETE_POST'); ?></span></td>
		  </tr>
		  <?php
...
?>
		  <tr> 
			<td></td>
			<td><span class="gen"><?php echo isset($this->vars['S_TYPE_TOGGLE']) ? $this->vars['S_TYPE_TOGGLE'] : $this->lang('S_TYPE_TOGGLE'); ?></span></td>
		  </tr>
		  <?php
...
?>
	...
	<tr> 
	  <td class="catBottom" colspan="2" align="center" height="28"> <?php echo isset($this->vars['S_HIDDEN_FORM_FIELDS']) ? $this->vars['S_HIDDEN_FORM_FIELDS'] : $this->lang('S_HIDDEN_FORM_FIELDS'); ?>
	  <!-- Begin SpelChek? code snippet #2 --> <input type="button" value="SpelChek" name="SpelChek" class="mainoption" LANGUAGE="javascript" onclick="document.send.edittext.value=''; sendtext()"> &nbsp;   <!--  End SpelChek? code snippet #2  -->
	  <input type="submit" tabindex="5" name="preview" class="mainoption" value="<?php echo isset($this->vars['L_PREVIEW']) ? $this->vars['L_PREVIEW'] : $this->lang('L_PREVIEW'); ?>" /> &nbsp;
	  <input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" /></td>
	</tr>
  </table>
