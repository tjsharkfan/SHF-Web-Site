...
// eXtreme Styles mod cache. Generated on Wed, 12 Oct 2005 17:47:04 -0700 (time=1129164424)
...
<p><?php echo isset($this->vars['USER_CAL_LEVEL']) ? $this->vars['USER_CAL_LEVEL'] : $this->lang('USER_CAL_LEVEL'); ?></p>	<!-- MOD Calendar -->
<p><?php echo isset($this->vars['USER_GALLERY_LEVEL']) ? $this->vars['USER_GALLERY_LEVEL'] : $this->lang('USER_GALLERY_LEVEL'); ?></p>	<!-- MOD Gallery -->
...
?>
<p><?php echo isset($this->vars['GROUP_CAL_LEVEL']) ? $this->vars['GROUP_CAL_LEVEL'] : $this->lang('GROUP_CAL_LEVEL'); ?></p> <!-- MOD Calendar -->
<p><?php echo isset($this->vars['GROUP_GALLERY_LEVEL']) ? $this->vars['GROUP_GALLERY_LEVEL'] : $this->lang('GROUP_GALLERY_LEVEL'); ?></p>	<!-- MOD Gallery -->
