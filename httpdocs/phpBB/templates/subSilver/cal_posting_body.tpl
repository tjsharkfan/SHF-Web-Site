			  ...
			  <td class="row3" colspan="2" align="center"><span class="gen"><b>{date_info.L_CAL_TITLE}</b></span></td>
	                ...
	                <tr> 
                	  ...
                	  <td class="row2"> <span class="gen"> 
        	            <select name=day size=1 class="post" style="width: 50px">
                	      {date_info.THIS_DAY}
	                    </select>
        	            <select size=1 name=month class="post">
                	      {date_info.THIS_MONTH}
	                    </select>
        	            <select name=year size=1 class="post">
                	      {date_info.THIS_YEAR}
	                    </select>
        	            </span>
			<script language="JavaScript" type="text/javascript">
...
<!-- BEGIN access_choices -->
	<tr>
	  <td class="row1" width="22%"><span class="gen"><strong>{access_choices.L_EVENT_ACCESS}</strong></span></td>
...
<!-- BEGIN group_choices -->
	<tr>
	  <td class="row1" width="22%" valign='top' align='right'><span class="genmed">{group_choices.L_GROUP_CHOICE}</span></td>
