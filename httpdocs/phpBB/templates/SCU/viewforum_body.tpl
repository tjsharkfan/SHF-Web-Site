<!-- <td align="right" valign="top"> <span class="gen">{S_WATCH_FORUM}</span> </td><br /> -->
...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  ...
	  <td align="right" valign="top" nowrap="nowrap"> <span class="gen"><b>{S_WATCH_FORUM}</b></span><br /><br /> <span class="gensmall"><b>{PAGINATION}</b></span></td>
	</tr>
	<tr> 
  ...
  <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1" width="100%" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR1}" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
