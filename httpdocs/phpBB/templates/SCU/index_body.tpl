...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    ...
    <td class="row1" width="100%" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR1}" onclick="window.location.href='{catrow.forumrow.U_VIEWFORUM}'"> <span class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink">{catrow.forumrow.FORUM_NAME}</a><br /> </span> <span class="genmed">{catrow.forumrow.FORUM_DESC}<br /></span><span class="gensmall">{catrow.forumrow.L_MODERATOR} {catrow.forumrow.MODERATORS}</span></td>
