...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		<td class="row1"><span class="gen">{L_EMAIL_ADDRESS_2}: </span><br />
		<span class="gensmall">In addition, forum E-mail notifications will be sent to this other E-mail address.</span></td>
		<td class="row2"><input type="text" class="post" style="width:200px" name="email_2" size="25" maxlength="255" value="{EMAIL_2}" /></td>
	</tr>
	...
	<tr> 
		<td class="row1"><span class="gen">{L_CONFIRM_CODE}: * </span><br /><span class="gensmall">{L_CONFIRM_CODE_EXPLAIN}</span></td> <td class="row2"><input type="text" class="post" style="width: 200px" name="confirm_code" size="6" maxlength="6" value="" /></td> 
	</tr> 
	<!-- END switch_confirm --> 
	...
	<tr> 
	  <td class="row1"><span class="gen">{L_PUBLIC_VIEW_EMAIL}:</span><br />
