...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr>
    <td align="left" class="nav" width="100%"><a href="{U_INDEX}" class="nav">{L_INDEX}</a></td>
    <td align="right" nowrap="nowrap"><span class="gensmall"><b>{PAGINATION}</b></span></td>
  </tr>
</table>
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="4" border="0">
  ...
  <tr> 
    <td class="row1" width="25%"><span class="gen">{L_GROUP_NAME}:</span></td>
    <td class="row2"><span class="gen"><b>{GROUP_NAME}</b></span></td>
  </tr>
  <tr> 
    <td class="row1" width="25%"><span class="gen">{L_GROUP_DESC}:</span></td>
    <td class="row2"><span class="gen">{GROUP_DESC}</span></td>
  </tr>
  <tr> 
    <td class="row1" width="25%"><span class="gen">{L_GROUP_MEMBERSHIP}:</span></td>
  ...
  <tr> 
    <td class="row1" width="25%"><span class="gen">{L_GROUP_TYPE}:</span></td>
  ...
  <!-- BEGIN JSL Mod 1 -->
  <tr>
    <td class="row1" width="25%"><span class="gen">Group disk space quota:</span></td>
    <td class="row2"><span class="gen"><b>{QUOTA}</b> </span></td>
  </tr>
  <tr>
    <td class="row1" width="25%"><span class="gen"> Group disk space consumed:</span></td>
    <td class="row2"><span class="gen"><b>{UPLOADED}</b> </span></td>
  </tr>
  <!-- END JSL Mod 1 -->
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    <td class="catSides" colspan="8" height="28"><span class="cattitle">{L_GROUP_MEMBERS}</span>
    <!-- BEGIN switch_mod_option -->
...
<table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
  <tr>
    <td align="left" width="100%"><a href="{U_INDEX}" class="nav">{L_INDEX}</a></td>
    <td align="right" nowrap="nowrap"><span class="gensmall">{S_TIMEZONE}</span></td>
  </tr>
  <tr>
...
<!-- Moved {PENDING_USER_BOX} from here to line above to fix template bug -->
