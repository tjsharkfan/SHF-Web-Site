...
<form action="{S_CONFIG_ACTION}" method="post">
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr>
      <td class="catBottom" colspan="2" align="center">Calendar Pro: <b>{CAL_VERSION}</b></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td class="row1">{L_ADMIN_PRIVATE_VIEW}</td>
      <td class="row2"><input type="radio" name="admin_private_view" value="1" {S_ADMIN_PRIVATE_VIEW_YES} />
        {L_YES}&nbsp;&nbsp; <input type="radio" name="admin_private_view" value="0" {S_ADMIN_PRIVATE_VIEW_NO} />
        {L_NO}</td>
    </tr>
    <tr> 
