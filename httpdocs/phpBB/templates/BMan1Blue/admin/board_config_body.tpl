...
<form action="{S_CONFIG_ACTION}" method="post"><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr> 
		<td class="row1" valign="top">{L_POST_SUBJECT}<br /><span class="gensmall">{L_POST_SUBJECT_EXPLAIN}</span></td>
		<td class="row2"><input type="radio" name="post_subject" value="0" {POST_SUBJECT_NONE} /> {L_POST_SUBJECT_NONE}<br /><input type="radio" name="post_subject" value="1" {POST_SUBJECT_USERNAME} /> {L_POST_SUBJECT_USERNAME}<br /><input type="radio" name="post_subject" value="2" {POST_SUBJECT_SUBJECT} /> {L_POST_SUBJECT_SUBJECT}<br /><input type="radio" name="post_subject" value="3" {POST_SUBJECT_HIDE} /> {L_POST_SUBJECT_HIDE}</td> 
	</tr> 

	<tr>
		<td class="row1">{L_POST_SUBJECT_PREFIX}<br /><span class="gensmall">{L_POST_SUBJECT_PREFIX_EXPLAIN}</span></td>
		<td class="row2"><input class="post" type="text" size="25" maxlength="25" name="post_subject_prefix" value="{POST_SUBJECT_PREFIX}" /></td>
	</tr>
