...
$lang['Disallowed_extension'] = 'The file extension <b>.%s</b> is not on the allowed list. <br/> <br/>Please contact <a href="mailto:jeff@scuemba.com">Admin Jeff<a/> to add this file type to the allowed list.'; // replace %s with extension (e.g. .php) 
...
$lang['Attachment_too_big'] = '<font color="red"> <b> The Attachment is too big; the maximum file attachment size is %d %s </b> </font> <br/> <br/> 
Instead, use <a href="http://www.yousendit.com">www.yousendit.com</a> to share this file.'; 
...
$lang['Pm_quota'] = 'PM Quota';
 // Original Code: $lang['User_upload_quota_reached'] = 'Sorry, you have reached your maximum Upload Quota Limit of %d %s'; // replace %d with Size, %s with Size Lang (MB for example)
$lang['User_upload_quota_reached'] = '<font color="red"> <b> Oops! You have reached your maximum Upload Quota Limit of %d %s </b> </font> <br/> <br/> 
You can either: Ask <a href="mailto:jeff@scuemba.com">Admin Jeff<a/> for more disk space (cell #408-832-7387), email the file, <br/>
free up space by deleting old posts with large attachments, or use <a href="http://www.yousendit.com">www.yousendit.com. </a>'; // replace %d with Size, %s with Size Lang (MB for example)
