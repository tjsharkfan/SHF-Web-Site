...
if( isset($HTTP_GET_VARS['perform']) || isset($HTTP_POST_VARS['perform']) )
{
	...
	switch($perform)
	{
		case 'backup':
			...
			$tables = array('attach_quota', 'attachments', 'attachments_config', 'attachments_desc', 'auth_access', 'banlist', 'cal_categories', 'cal_config', 'cal_recur', 'calendar', 'cal_group_event', 'categories', 'config', 'confirm', 'disallow', 'extension_groups', 'extensions', 'forbidden_extensions', 'forums', 'forum_prune', 'forums_watch', 'groups', 'news', 'posts', 'posts_text', 'privmsgs', 'privmsgs_text', 'quota_limits', 'ranks', 'search_results', 'search_wordlist', 'search_wordmatch', 'sessions', 'smilies', 'themes', 'themes_name', 'topics', 'topics_watch', 'user_group', 'users', 'vote_desc', 'vote_results', 'vote_voters', 'words', 'confirm');
