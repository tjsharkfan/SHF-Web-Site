...
$params = array('mode' => 'mode', 'user_id' => POST_USERS_URL, 'group_id' => POST_GROUPS_URL, 'adv' => 'adv', 'gallerylevel' => 'gallerylevel');
...
else if ( ( $mode == 'user' && ( isset($HTTP_POST_VARS['username']) || $user_id ) ) || ( $mode == 'group' && $group_id ) )
{
	...
	else
	{
		...
		$template->assign_vars(array(
			...
			'GROUP_GALLERY_LEVEL' => "Gallery Level : " . $s_gallery_type,
