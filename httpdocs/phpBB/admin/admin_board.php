...
$post_subject_none = ( $new['post_subject'] == 0 ) ? "checked=\"checked\"" : ""; 
$post_subject_username = ( $new['post_subject'] == 1 ) ? "checked=\"checked\"" : ""; 
$post_subject_subject = ( $new['post_subject'] == 2 ) ? "checked=\"checked\"" : ""; 
$post_subject_hide = ( $new['post_subject'] == 3 ) ? "checked=\"checked\"" : ""; 
...
$template->assign_vars(array(
	...
	"L_POST_SUBJECT_EXPLAIN" => $lang['Post_subject_explain'],
	"L_POST_SUBJECT_NONE" => $lang['Acc_None'],
	"L_POST_SUBJECT_USERNAME" => $lang['Post_subject_username'],
	"L_POST_SUBJECT_SUBJECT" => $lang['Post_subject_subject'],
	"L_POST_SUBJECT_HIDE" => $lang['Post_subject_hide'],
	"L_POST_SUBJECT_PREFIX" => $lang['Post_subject_prefix'],
	"L_POST_SUBJECT_PREFIX_EXPLAIN" => $lang['Post_subject_prefix_explain'],
	...
	"POST_SUBJECT_NONE" => $post_subject_none, 
	"POST_SUBJECT_USERNAME" => $post_subject_username, 
	"POST_SUBJECT_SUBJECT" => $post_subject_subject, 
	"POST_SUBJECT_HIDE" => $post_subject_hide, 
	"POST_SUBJECT_PREFIX" => $new['post_subject_prefix'],
