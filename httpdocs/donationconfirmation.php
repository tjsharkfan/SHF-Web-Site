<?php
    ...
    $name = $addr = $apt = $pobox = $city = $state = $zip = $lvl = $type = $length = "";
    ...
    //Send email notification to SHF treasurer 
        ...
        if ($type == "new") {$subject = "New SHF membership";} else {$subject = "SHF membership Renewal";}  
    ...
    */
    //This code will log a donation to a text file in the transaction folder on the web server.
    include 'PaypalTransactionLog.php';
    $result = logPayPalTransaction("Donation",$name,$addr, $apt, $pobox, $city, $state, $zip, $donationAmount, "N/A", "N/A", "N/A", $ppl_trx_id, $ppl_payer_name, $ppl_trx_timestamp);    
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder">
      ...
      <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                ...
                <tr>
                    <td width="100%" class="headline" style="text-align:center"><strong>Saratoga Historical Foundation Donation Confirmation</strong></td>
                </tr>
                <tr>
                <td>
                <p>Thank you for your Saratoga Historical Foundation donation.</p>
                </td>
                </tr>
                <td>
                <p>The details of your donation are as follows:</p>
                <table>
                <tr><td>Member Name: </td><td><?php echo $name?></td>
                <tr><td>Address: </td><td><?php echo $addr?></td></tr>
                </tr><?php if ($apt != "") {echo "<tr><td>Apartment: </td><td>{$apt}</td></tr>";}?>
                </tr><?php if ($pobox != "") {echo "<tr><td>P.O. Box: </td><td>{$pobox}</td></tr>";}?>
                <tr><td>City: </td><td><?php echo $city?></td></tr>
                <tr><td>State: </td><td><?php echo $state?></td></tr>
                <tr><td>Zip Code: </td><td><?php echo $zip?></td></tr>
                <tr><td>Donation Amount: </td><td><?php echo "$" . $donationAmount?></td></tr>
                </table>
                <br>
                <table>
                ...
                <tr><td>Transaction Date: </td><td><?php echo $ppl_trx_timestamp?></td>
                </table>
            </table>  
            <style type="text/css">
               @media print {
