...
//Initialiaze variables
    $name = $addr = $apt = $pobox = $city = $state = $zip = $donationAmount = "";
    ...
    $state = $_POST["state"];
    $zip = $_POST["zip"];
    if ($_POST["donation_amount"] == "Other") {
        $donationAmount = $_POST["donation_amount_other"];
    } else {
    ...
    <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder">
      ...
      <tr>
            ...
            <form method="post" action="donationconfirmation.php" id="submit_donationform">
            <table width="100%" border="0" cellspacing="0" cellpadding="10">
                <tr>
                    <td colspan="3" class="headline" style="width: 100%; text-align: center"><strong>SHF Donation Confirmation</strong></td>
                </tr>
                <tr>
                    <td colspan="3" class="fontlarge" style="width: 100%; text-align: center">
                      ...
                      Select one of the PayPal buttons to complete the donation.
                    </td>
                </tr>
                <tr>
                    <td colspan="3" class="fontlarge" style="width: 100%; text-align: left">
                    <div>
		              <label for="name">Name:</label> <input type="text" name="name" value="<?php echo $name; ?>" readonly><br>
		              <label for="addr">Street Address:</label> <input type="text" name="addr" value="<?php echo $addr; ?>" readonly><br>
		              <label for="apt"> Appartment:</label> <input type="text" name="apt" value="<?php echo $apt; ?>" readonly><br>
		              <label for="pobox"> PO Box:</label> <input type="text" name="pobox" value="<?php echo $pobox; ?>" readonly><br>
		              <label for="city"> City:</label> <input type="text" name="city" value="<?php echo $city; ?>" readonly><br>
		              <label for="state"> State:</label> <input type="text" name="state" value="<?php echo $state; ?>" readonly><br>
		              <label for="zip"> ZIP Code:</label> <input type="text" name="zip" value="<?php echo $zip; ?>" readonly></br>
		              <label for="donationamount"> Donation Amount:</label> <input type="text" name="donationamount" value="<?php echo $donationAmount; ?>" readonly></br>
                ...
                <tr>
                    ...
                    // This function sets up the details of the transaction, including the amount and line item details.
                      return actions.order.create({
                        purchase_units: [{
		                      description: 'SHF Donation',
                          amount: {
                            value: '<?php echo $donationAmount; ?>'
                            }
                        }],
                        application_context: {
                    ...
                    onApprove: function(data, actions) {
                      ...
                      return actions.order.capture().then(function(details) {
                        ...
                        document.getElementById("submit_donationform").submit();
